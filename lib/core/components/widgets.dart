...
class Widgets {
  ...
  static String timeAgo(dynamic input, {String? prefix}) {
    ...
    bool isPast =
        finalDateTime.millisecondsSinceEpoch <=
    ...
    return Padding(
      ...
      child: Center(
        child: Padding(
          ...
          child: Icon(Icons.delete, size: 100, color: Colors.grey.shade300),
        ),
      ),
    );
  }
  ...
  static Widget divider({Color? color}) {
    return Padding(
      ...
      child: Divider(height: 4.5, color: color),
    );
  }
  ...
  static Widget heading({dynamic text}) {
    return Padding(
      ...
      child: Txt(text: text, color: Colors.grey, fontWeight: FontWeight.bold),
    );
  }
